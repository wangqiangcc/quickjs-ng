...
{
    return InterlockedOr64(object, operand);
}
...
{
    return InterlockedXor64(object, operand);
}
...
{
    return InterlockedAnd64(object, operand);
}
...
{
    return InterlockedExchange64(object, desired);
}
